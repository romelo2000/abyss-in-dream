...
// Find pdfmake in node_modules
const pdfmakePath = path.join(__dirname, '..', 'node_modules', 'pdfmake')
const PdfPrinter = require(path.join(__dirname, '..', 'node_modules', 'pdfmake', 'src', 'Printer.js')).default || require(path.join(__dirname, '..', 'node_modules', 'pdfmake', 'src', 'Printer.js'))
...
const docDefinition = {
  ...
  content: [
    ...
    { text: '◉', style: 'symbol', alignment: 'center', margin: [0, 0, 0, 30], fontSize: 36, color: '#3d3e80' },
    ...
    { text: 'Каждая сессия — это «сон», который проходит через 5 фаз:', style: 'normal', margin: [0, 0, 0, 8] },
